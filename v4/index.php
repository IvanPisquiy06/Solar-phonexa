                        ...
                        <div id="form_box" class="form_box">
                            ...
                            <form id="msform" class="form" action="thank-you.php?" novalidate method="post">
                                ...
                                <fieldset id="form-step10" class="form-steps fieldset-9" data-step="10" style="display: none;" data-tag="phone">
                                    ...
                                    <div class="form-group">
                                        <input id="phone" class="form-control" type="text" name="phone_home" placeholder="(000) 000-0000" value="" required minlength="10" maxlength="16" data-tf-value="(702) 555-1212">
                                    ...
                                    <span class="terms_txt">
                                        <label id="tcpa_label">
                                            ...
                                            <a href="terms.php" target="_new">four solar companies</a>
                                            to call you or SMS message the phone number provided, even if it is currently listed on any state, federal, or corporate 'Do Not Call' lists, and you understand that they may use automated dialing or prerecorded message to call you, and that your consent is not required to purchase products or services.</label>
                                    </span>
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-btns ml-auto text-right btn-last-submit">
                                                <button id="q10-next" class="btn form-btn btn-next btn-final" type="button"><span class="btn-text" name="q10-button">Next</span>
                                                </button>
            ...
            <div class="solar-footer-content">
                ...
                <div class="row">
                    <div class="footer-menu">
                        ...
                        <a href="privacy.php" target="_new">Privacy</a>. </label> </div>
                        <div id="footer" class="form-group"> Policies.
        ...
        <div class="modal-content">
            ...
            <div class="tcpa-content-container">
                <div id="terms-php" class="hidden">
                    ...
                    <p>
                        We at EcomfyLead respect and protect the privacy of our users. Your use of our Smart Services may transmit information, including possibly personally identifiable information. The collection and use of this personal information collected by smartsolarsavings.com is governed by our <a href="privacy.php" title="Privacy Policy">Privacy Policy</a>, hereby incorporated by reference in its entirety. It’s important that you read and comprehend the terms of our <a href="privacy.php" title="Privacy Policy">Privacy Policy</a>. EcomfyLead, Inc. may cooperate and disclose various information (including your account information) to authorities, government officials or third parties without notice to you in connection to investigations, proceedings, or claims that arise from asserted illegal actions/infringements related or unrelated to your use/misuse of the Website.</p>
    ...
    <script async>
        ...
        function MeasureDuration(type) {
            return {
                ...
                capture: function(sub_type) {
                    ...
                    $.get("/v4/papi/persist.php?op=" + type + "&sub_type=" + sub_type + "&duration=" + spentTime, function(data) {
                        /* do nothing */
                    });
                }
            }
        ...
        function Application() {
            ...
            $("#btn-save").click(function(e) {
                ...
                working.show();
                ajaxVerify("/v4/papi/validate.php?op=location&version=v4&postal=" + postal, function(response) {
            ...
            function makeRequest(step) {
                ajaxVerify("/v4/papi/validate.php?op=next&step=" + step + "&version=v4", function(response) {
                    // do nothing for now
                }, function() {
                    // do nothing for now
                });
            ...
            function iwVerify(em, zip) {
                if (!iwVerified) {
                    ajaxVerify("/v4/papi/validate.php?op=iw&version=v4&address=" + em + "&zip=" + zip,
                        function() {
            ...
            function displayError(field, error) {
                ...
                $.get("/v4/papi/persist.php?op=form_error&sub_type=" + field_id + "&error=" + encodeURIComponent(error), function(data) {
                    /* do nothing */
                });
            ...
            let persistClickEngagement = () => {
                $.get("/v4/papi/persist.php?op=click", function(data) {
                    /* do nothing */
                });
            ...
            function handleNextClick(e) {
                ...
                function submitForm() {
                    ...
                    if (timesSubmitted >= 1) {
                        ...
                        */
                        ...
                        function pollForSuccess(conversion_id, success, async) {
                            timesPolled++;
                            if (timesPolled > 15) {
                                success();
                                return;
                            }
                            $.get("/v4/papi/validate.php?op=posted&version=v4&id=" + conversion_id, function(res) {
                ...
                if (email.is(":visible")) {
                    ...
                    working.show();
                    const path = "/v4/papi/validate.php?op=email&version=v4&address=" + value + "&zip=" + zip.val();
                    ajaxVerify(path,
                        function(data) {
                            working.hide();
                            window._loq.push(['custom', {
                ...
                if (phone.is(":visible")) {
                    ...
                    working.show();
                    const path = "/v4/papi/validate.php?op=phone&number=" + lookupValue + "&version=v4";
                    ajaxVerify(path,
                        function() {
                            working.hide();
                            window._loq.push(['custom', {
            ...
            inputs.forEach(input => {
                input.addEventListener("invalid", (e) => {
                        ...
                        $.get("/v4/papi/persist.php?op=error&sub_type=" + input.id + "&error=failed+html5+rule", function(data) {
                            /* do nothing */
                        });
                        toggleSubmitButtons(true);
                    },
        ...
        const beforeunload = function() {
            ...
            elapsedTime += spentTime;
            // elapsedTime contains the time spent on page in milliseconds
            $.get("/v4/papi/persist.php?op=" + bounceType + "&duration=" + elapsedTime, function(data) {
                /* do nothing */
            });
        };
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            dependencyChain.then(function() {
                ...
                setTimeout(function() {
                    ...
                    $.get("/v4/papi/persist.php?op=pageview&sub_type=form&tags=" + encodeURIComponent(tags.join(',')), function(data) {
                        /* do nothing */
                    });
                }, 1500);

                function scrollEgngaged(event) {
                    $.get("/v4/papi/persist.php?op=scrolled", function(data) {
                        /* do nothing */
                    });
